  ...
  return (
    <section id="contact" className="contact" aria-label="Contacto">
      <div className="contact__grid">
        ...
        <div
          ref={leftRef}
          className={`contact__left reveal-left${leftVisible ? ' visible' : ''}`}
        >
          <div className="section-label">Contacto</div>
          <h2 className="contact__heading">
            VAMOS<br/>CRIAR <span>ALGO</span><br/>ÚNICO
          </h2>
          <p className="contact__desc">
            Cada encomenda é uma obra exclusiva. Seja uma t-shirt, uma tela, um mural ou
            um par de sapatilhas — o resultado será sempre único e artístico.
          </p>
          ...
          <form className="contact__form" onSubmit={handleSubmit} noValidate>
            <div className="form-row">
              <div className="form-group">
                ...
                <input id="cf-name" className="form-input" type="text" placeholder="O seu nome" required/>
              </div>
              <div className="form-group">
                <label className="form-label" htmlFor="cf-email">Email</label>
                <input id="cf-email" className="form-input" type="email" placeholder="o.seu@email.com" required/>
              </div>
            </div>
            <div className="form-group">
              <label className="form-label" htmlFor="cf-service">Tipo de Encomenda</label>
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="cf-msg">Descreva o Projecto</label>
              <textarea id="cf-msg" className="form-textarea"
                placeholder="Conte-me a sua ideia, dimensões, referências..." required/>
            </div>
            <button
              type="submit"
