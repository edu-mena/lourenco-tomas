...
export const GALLERY_ITEMS = [
  { id: 1, cat: 'tshirts', name: 'Retrato Mãe', title: 'Retrato Mãe', sub: 'T-Shirt · Aerografia',
    size: 'T-Shirt standard', technique: 'Aerografia têxtil', img: mediaUrl('/images/obras/arte1.jpeg'),
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Retrato Mãe" (ID: 1). Imagem: /images/obras/arte1.jpeg')}`,
    h: 340,
    grad: 'linear-gradient(145deg,#1a0d06 0%,#3a1e0c 35%,#4d2a12 55%,#281508 80%,#100908 100%)' },
  { id: 2, cat: 'telas', name: 'Alma Urbana', title: 'Alma Urbana', sub: 'Tela 60×80cm',
    size: 'Tela 60×80cm', technique: 'Aerografia em tela', img: mediaUrl('/images/obras/arte2.jpeg'),
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Alma Urbana" (ID: 2). Imagem: /images/obras/arte2.jpeg')}`,
    h: 460,
    grad: 'linear-gradient(155deg,#060b16 0%,#0e182d 35%,#141e36 55%,#0a1022 80%,#050812 100%)' },
  { id: 3, cat: 'murais', name: 'Luanda Viva', title: 'Luanda Viva', sub: 'Mural · Exterior',
    size: 'Mural médio', technique: 'Aerografia mural exterior', img: mediaUrl('/images/obras/arte3.jpeg'),
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Luanda Viva" (ID: 3). Imagem: /images/obras/arte3.jpeg')}`,
    h: 380,
    grad: 'linear-gradient(135deg,#0d1208 0%,#1a200f 35%,#222c18 55%,#141a09 80%,#090d05 100%)' },
  { id: 4, cat: 'calcados', name: 'Air Max Custom', title: 'Air Max Custom', sub: 'Calçado · Edição única',
    size: 'Calçado Nike Air Max', technique: 'Aerografia em couro', img: mediaUrl('/images/obras/arte4.jpeg'),
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Air Max Custom" (ID: 4). Imagem: /images/obras/arte4.jpeg')}`,
    h: 290,
    grad: 'linear-gradient(140deg,#150e0d 0%,#291818 35%,#371f1f 55%,#201010 80%,#0e0808 100%)' },
  { id: 5, cat: 'tshirts', name: 'Leão Africano', title: 'Leão Africano', sub: 'T-Shirt · Aerografia',
    size: 'T-Shirt regular', technique: 'Aerografia têxtil',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Leão Africano" (ID: 5).')}`,
    h: 380,
    grad: 'linear-gradient(150deg,#140e06 0%,#251809 35%,#312013 55%,#1c1308 80%,#0b0906 100%)' },
  { id: 6, cat: 'telas', name: 'Mulher de Luanda', title: 'Mulher de Luanda', sub: 'Tela 80×100cm',
    size: 'Tela 80×100cm', technique: 'Aerografia em tela',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Mulher de Luanda" (ID: 6).')}`,
    h: 500,
    grad: 'linear-gradient(160deg,#0f0812 0%,#1c1024 35%,#24162e 55%,#17101c 80%,#0b0812 100%)' },
  { id: 7, cat: 'murais', name: 'Identidade', title: 'Identidade', sub: 'Mural · Interior',
    size: 'Mural interior', technique: 'Aerografia mural',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Identidade" (ID: 7).')}`,
    h: 350,
    grad: 'linear-gradient(130deg,#110d08 0%,#201608 35%,#2c1f0e 55%,#1a1309 80%,#0b0908 100%)' },
  { id: 8, cat: 'calcados', name: 'Jordan x Art', title: 'Jordan x Art', sub: 'Calçado · Nike',
    size: 'Calçado Nike Jordan', technique: 'Aerografia em couro',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Jordan x Art" (ID: 8).')}`,
    h: 310,
    grad: 'linear-gradient(145deg,#090d16 0%,#10162c 35%,#161e38 55%,#0d1222 80%,#060810 100%)' },
  { id: 9, cat: 'tshirts', name: 'Retrato Ancestral', title: 'Retrato Ancestral', sub: 'T-Shirt · Série limitada',
    size: 'T-Shirt premium', technique: 'Aerografia têxtil',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Retrato Ancestral" (ID: 9).')}`,
    h: 420,
    grad: 'linear-gradient(155deg,#110b07 0%,#221408 35%,#2e1e0c 55%,#1c1208 80%,#0b0906 100%)' },
  { id: 10, cat: 'telas', name: 'Cosmos Africano', title: 'Cosmos Africano', sub: 'Tela 50×70cm',
    size: 'Tela 50×70cm', technique: 'Aerografia em tela',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Cosmos Africano" (ID: 10).')}`,
    h: 340,
    grad: 'linear-gradient(140deg,#0c1009 0%,#172012 35%,#1f2c19 55%,#131a0d 80%,#090e07 100%)' },
  { id: 11, cat: 'murais', name: 'Raízes', title: 'Raízes', sub: 'Mural · Projecto público',
    size: 'Mural grande', technique: 'Aerografia exterior',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Raízes" (ID: 11).')}`,
    h: 440,
    grad: 'linear-gradient(125deg,#0e0b08 0%,#1a1610 35%,#241e15 55%,#18140d 80%,#0d0a08 100%)' },
  { id: 12, cat: 'calcados', name: 'Vans Custom', title: 'Vans Custom', sub: 'Calçado · Vans',
    size: 'Calçado Vans', technique: 'Aerografia em lona',
    priceHref: `https://wa.me/${WA_NUMBER}?text=${encodeWaMessage('Olá Lourenço! Quero preço para a obra "Vans Custom" (ID: 12).')}`,
    h: 270,
...
export const VIDEOS = [
  { id: 1, featured: true,  label: 'Destaque · 4:32', title: 'Retrato em Tempo Real — do branco ao rosto',
    src: mediaUrl('/videos/Aerografia.mp4'),
  ...
  { id: 2, featured: false, label: 'Time-lapse · 1:15', title: 'Mural Urbano — 8 horas em 75 segundos',
    src: mediaUrl('/videos/Desfile.mp4'),
  ...
  { id: 3, featured: false, label: 'Tutorial · 2:48', title: 'T-Shirt Customization — técnicas de gradiente',
    src: mediaUrl('/videos/Santuario.mp4'),
